...
#         if image_pair_dict_all[img] in image_all_path:
...
#     commandline = 'cp '+ retrival_colored + ' ./retrival_colored_val/'+img_name[:-4]+'_pair.png'
#     commandline2 = 'cp '+ query_colored + ' ./retrival_colored_val/'
#     print(commandline)
#     print(commandline2)
...
save_image_pair = 'retrival_img_pairs_val'+str(processid)+'.pkl'
print(save_image_pair)
interval = 100
image_pair_dict = {}
no_foreground_list = []
for i,label_img_path in enumerate(label_paths):
