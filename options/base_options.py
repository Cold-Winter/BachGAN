...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--box', action='store_true', help='if true, take bounding box as input')
        parser.add_argument('--retrival', action='store_true', help='if true, take bounding box and retrival segment as input')
        parser.add_argument('--retrival_memory', action='store_true', help='if true, take bounding box and retrival segment as input')
        parser.add_argument('--box_unpair', action='store_true', help='if true, take bounding box as input and unpaired fine label as proxy task')
        parser.add_argument('--dual', action='store_true', help='if true, use dual spade for box and fine layout')
        parser.add_argument('--seg', action='store_true', help='if true, use seg loss as proxy loss')
        parser.add_argument('--dual_segspade', action='store_true', help='if true, use dual spade for box and fine layout and use seg to regress box as the input of spade norm')
